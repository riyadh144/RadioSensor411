...
{  
  ...
  GPIO_InitStructure.Mode = GPIO_AF12_SDIO;
  GPIO_InitStructure.Alternate = GPIO_OTYPER_OT0;
  ...
  GPIO_PinAFConfig(SPI_SCK_GPIO_PORT, GET_GPIO_SOURCE(GPIO_PIN_10), GPIO_AF5_SPI2);
  
  /* SPI MOSI pin configuration */
  GPIO_InitStructure.Pin =  SPI_MOSI_PIN;
  GPIO_Init(SPI_MOSI_GPIO_PORT, &GPIO_InitStructure);
  GPIO_PinAFConfig(SPI_MOSI_GPIO_PORT, GET_GPIO_SOURCE(GPIO_PIN_3), GPIO_AF5_SPI2);
}
...
static void WaveRecorder_SPI_Init(uint32_t Freq)
{
  ...
  /* SPI configuration */
  SPI_I2S_DeInit(SPI2);
  I2S_InitStructure.AudioFreq = 32000;
  I2S_InitStructure.Standard = I2S_STANDARD_LSB;
  I2S_InitStructure.DataFormat = I2S_DATAFORMAT_16B;
  I2S_InitStructure.CPOL = I2S_CPOL_HIGH;
  I2S_InitStructure.Mode = I2S_MODE_MASTER_RX;
  I2S_InitStructure.MCLKOutput = I2S_MCLKOUTPUT_DISABLE;
